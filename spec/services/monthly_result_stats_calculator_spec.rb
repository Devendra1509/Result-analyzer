...
RSpec.describe MonthlyResultStatsCalculator, type: :service do
  describe '.monthly_result' do
     ...
     before do
      ...
      create(:daily_result_stat, subject: 'Science', date: today - 3.days, daily_low: 75.00, daily_high: 80.00, result_count: 70)
      create(:daily_result_stat, subject: 'Science', date: today - 4.days, daily_low: 70.00, daily_high: 75.00, result_count: 40)
      create(:daily_result_stat, subject: 'Science', date: today - 5.days, daily_low: 65.00, daily_high: 70.00, result_count: 30)
    ...
    it 'calculates the correct monthly averages for Science' do
      ...
      expect(science_avg.monthly_result_count_used).to eq(total_count)
    end
  end
end
